@if(\Illuminate\Support\Facades\Request::route()->uri == "/")
                    ...
                    <div class="navbar-inner nav">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="index.html">
                                <img src="img/badger.png" alt="Image Alternative text" title="Image Title"/>
                            </a>
                        </div>
                        <div class="collapse navbar-collapse" id="navbar-main">
                            <ul class="nav navbar-nav">
                                <li class="dropdown">
                                    <a style="font-weight: bolder; color: white" class="dropdown-toggle" href="{{url("/")}}" >
                                        Travel Badger
                                    </a>
                                </li>
                                <li class="active dropdown">
                                    <a class="dropdown-toggle" href="flight-index-1.html" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Buses</a>
                                </li>
                                <li class="dropdown">
                                    <a class="dropdown-toggle" href="car-index-1.html" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Flights</a>
                                </li>
                            </ul>
                            <ul class="nav navbar-nav navbar-right">
                                <li class="dropdown">
                                    <a class="dropdown-toggle" href="{{url("admin")}}" role="button" aria-haspopup="true" aria-expanded="false">
                                        Administrator
                                    </a>
                                </li>
                                <li class="dropdown">
